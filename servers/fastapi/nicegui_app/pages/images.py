    ...
    with ui.column().classes("w-full p-6 gap-4"):
        ...
        with ui.row().classes("w-full gap-6 items-start flex-wrap"):
            ...
            with ui.card().classes("w-96"):
                ...
                gen_btn = ui.button("生成", icon="auto_awesome", on_click=lambda: gen_image()).props("color=primary")
        ...
        with ui.card().classes("w-full"):
            with ui.row().classes("items-center justify-between"):
                ...
                ui.button("刷新", icon="refresh", on_click=lambda: load_images()).props("flat")
                ...
                with generated_grid:
                    with ui.card().classes("w-40"):
                        ...
                        with ui.row().classes("justify-between items-center"):
                            ...
                            ui.button(icon="delete", on_click=lambda iid=img_id: del_img(iid)).props("flat round dense color=negative size=sm")
